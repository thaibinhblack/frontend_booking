...
export default {
    ...
    watch:{
        item_service(newVal)
        {
            ...
            this.service.NAME_SERVICE = newVal.NAME_SERVICE
    ...
    methods: {
        ...
        addService()
        {
            ...
            if(this.update == false)
            {
                ...
                {
                    this.$http.post(this.$store.state.API_URL + "service?api_token="+this.$session.get('token'),data)
                    .then((response) => {
                        this.service = {}
            ...
            {
                this.$http.post(this.$store.state.API_URL + "service/"+this.service.UUID_SERVICE+'/update?api_token='+this.$session.get('token'),data)
                .then((response) => {
                    this.message.type = 'success'
