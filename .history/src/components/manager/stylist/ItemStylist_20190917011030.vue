                        ...
                        <div class="item-stylist" >
                            <div class="image-stylist" style="text-align:center;">
                                ...
                                <input type="file" ref="MyAvatar" @change="renderAvatar()">
                                    ...
                                    <img v-else :src="PUBLIC_URL + stylist.URL_STYLIST" alt="">
                                </v-avatar>
                            </div>
        ...
        createStylist()
        {
            if(this.update == false)
            {
                ...
                else
                {
                    ...
                    this.$http.post(this.BASE_URL + 'stylist',data)
                    .then((response) => {
            ...
            else
            {
                ...
                data.append("NAME_STYLIST",this.stylist.NAME_STYLIST)
                this.$http.post(this.BASE_URL + 'stylist/'+this.stylist.UUID_STYLIST+'/update',data)
                .then((response) => {
