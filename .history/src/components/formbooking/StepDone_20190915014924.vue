...
export default {
    ...
    methods: 
    {
        ...
        deleteBooking()
        {
            axios.post(this.BASE_URL+'booking/'+this.infoBooking.UUID_BOOKING+'/update',{
                type: 'delete'
            })
            .then((response) => {
                this.$router.push('/')
        ...
        ApiSendMail()
        {
            this.$http.get(this.BASE_URL + 'booking?phone='+this.$route.params.phone).then((response ) => {
                const email = {
                ...
                this.$http.get(this.BASE_URL + 'user?UUID_COUNTRY='+this.infoStore.UUID_COUNTRY).then((response) => {
                    email.EMAIL_SEND = response.data.EMAIL
                    console.log(email)
                    this.$http.post(this.BASE_URL + 'email',email)
                })
            })
        }
    }
