...
export default {
    ...
    methods: 
    {
        getInfoBookingByPhone()
        {
            ...
            axios.get(this.$store.state.API_URL + 'booking/'+ this.getPhone).
            then( (response) => {
        ...
        InfoStore()
        {
            axios.get(this.$store.state.API_URL + 'room/'+this.infoBooking.UUID_ROOM+'?store=1').
            then((response) => {
                console.log(response.data)
        ...
        InffoService()
        {
            axios.get(this.$store.state.API_URL+'detail-service/'+this.infoBooking.UUID_BOOKING).then((response) => {
        ...
        deleteBooking()
        {
            axios.post(this.$store.state.API_URL+'booking/'+this.infoBooking.UUID_BOOKING+'/update',{
                type: 'delete'
            })
            .then((response) => {
                this.$router.push('/')
        ...
        PrveBooking()
        {
            axios.delete(this.$store.state.API_URL +'detail-service/'+this.infoBooking.UUID_BOOKING)
            .then((response) => {
                console.log(response.data)
                this.commitStep(1)
            })
