        ...
        <div style="padding:15px;">
            <div class="list-service">
                ...
                <v-tabs v-model="tab_service">
                    ...
                    <v-tab-item>
                        <tab-stylist :tab_service="tab_service"/>
                    </v-tab-item>
                    <v-tab-item>
                        <!-- <tab-code/> -->
                    </v-tab-item>
            ...
            <v-tabs v-model="tabs">
                <v-tab class="item-tab"><h4 style="width:100%;">CHỦ NHẬT</h4></v-tab>
                    ...
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="0" @checkRoom="checkedRoom = $event"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="1" />
                    </v-tab-item>
                    <v-tab-item> 
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="2"/>
                    </v-tab-item>
                    <v-tab-item> 
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="3"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="4" />
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="5"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tabs="tabs" :tab="6" />
                    </v-tab-item>
