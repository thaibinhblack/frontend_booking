...
export default {
    ...
    methods:
    {
        ...
        NextStep()
        {
            if(this.booking.NAME_BOOKING == '' && this.booking.EMAIL_BOOKING && this.checkedService.length == 0 && this.booking.TIME_BOOK )
            {
                this.message.type = 'warning'
                if(this.booking.NAME_BOOKING == '' && this.booking.EMAIL_BOOKING == '')
                {
