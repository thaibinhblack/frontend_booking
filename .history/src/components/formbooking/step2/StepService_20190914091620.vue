        ...
        <div style="padding:15px;">
            ...
            <v-tabs v-model="tabs">
                <v-tab class="item-tab"><h4 style="width:100%;">CHỦ NHẬT</h4></v-tab>
                    ...
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tab="0" @checkRoom="checkedRoom = $event"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tab="1" />
                    </v-tab-item>
                    <v-tab-item> 
                        <tab-time :rooms="rooms" :tab="2"/>
                    </v-tab-item>
                    <v-tab-item> 
                        <tab-time :rooms="rooms" :tab="3"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tab="4" />
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tab="5"/>
                    </v-tab-item>
                    <v-tab-item>
                        <tab-time :rooms="rooms" :tab="6" />
                    </v-tab-item>
    ...
    methods:
    {
        ...
        ApiGetBooking()
        {
            ...
            .then((response) => {
                ...
                this.$http.get(this.BASE_URL + "room?type=UUID_STORE&value="+response.data.UUID_STORE).then((response) => {
