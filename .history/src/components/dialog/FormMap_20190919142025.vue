...
export default {
    ...
    methods: {
        addProvincetoDB()
        {
            ...
            {
                this.$http.post(this.$store.state.API_URL + "province", {
        ...
        FilterCountry()
        {
            this.$http.get("http://127.0.0.1:8000/api/v1/country/"+this.selectProvince+'?type=UUID_PROVINCE').then((response) => {
                    this.country = response.data
                })
        },
        readProvicetoDB()
        {
            this.$http.get("http://127.0.0.1:8000/api/v1/province").then((response) => {
                    this.provinces = response.data
                })
        },
        addCountrytoDB()
        {
            this.$http.post("http://127.0.0.1:8000/api/v1/country/",{
        ...
        updateCountry(item){
            console.log(item)
            // this.$http.put("http://127.0.0.1:8000/api/v1/country/"+item.UUID_COUNTRY,{
