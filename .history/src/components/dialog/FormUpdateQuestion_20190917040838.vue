        ...
        <v-card class="card-question">
            <v-form>
                ...
                <v-card-title primary-title>
                    FORM CẬP NHẬT CÂU HỎI {{question.NAME_QUESTION}} <span  class="btn-add-question" @click="numberQuestion++"><v-icon>mdi-plus</v-icon></span> 
                </v-card-title>
                <v-container>
                    <v-row>
...
export default {
    ...
    components: {
        'item-question': () => import('@/components/dialog/ItemQuestion.vue')
    },
}
</script>
