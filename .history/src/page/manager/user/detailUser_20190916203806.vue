    ...
    methods: {
        ...
        ApiGetInfoUser()
        {
            ...
            this.$http.get(this.$store.state.API_URL + 'user/'+this.$route.params.uuid+'?api_token='+this.$session.get('token')).then((response) => {
                ...
                this.ApiGetCountry(response.data.UUID_PROVINCE, 'UUID_COUNTRY')
        ...
        updatePassword()
        {
            ...
            {
                this.$http.get(this.$store.state.API_URL + 'user/'+this.$route.params.uuid+'?api_token='+this.$session.get('token')+'&PASSWORD='+ this.PASSWORD).then(() => {
                    this.message.type = 'success'
