<template>
    ...
    <v-card style="padding:25px;">
        ...
        <v-form @submit.prevent="updateUser()">
            ...
            <v-row>
                <v-col cols="12" sm="6" md="4">
                   <button class="btn-add btn"> <v-icon>mdi-update</v-icon> Cập nhật</button>
                    <v-btn color="warning" style="margin-left: 15px;" class="btn-add btn"><v-icon>mdi-delete</v-icon> Xóa</v-btn>
