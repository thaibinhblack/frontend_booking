    ...
    <v-card>
        ...
        v-model="selected">
            ...
            <template v-slot:item.actions="{ item }">
                <v-icon class="btn-table" color="success" v-if="item.CHECK_BOOKING == 2" title="Đã check" @click="checkBooking(item.UUID_BOOKING)">mdi-check</v-icon>
                <v-icon class="btn-table" color="error" v-else title="Chưa check" @click="DeleteBooking(item.UUID_BOOKING)">mdi-check</v-icon>
