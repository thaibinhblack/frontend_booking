...
export default {
    ...
    methods: {
        ApiGetBooking(){
            this.$http.get(this.BASE_URL + 'booking')
            .then((response) => {
        ...
        {
            this.$http.put(this.BASE_URL + "booking/"+UUID_BOOKING+"?check_booking=1")
            .then((response) => {
        ...
        {
            this.$http.delete(this.BASE_URL + "booking/"+UUID_BOOKING)
            .then((response) => {
                this.message.type = 'success'
